...
from data_transformation_sequence import SearchContext, SequenceState
...
from utils import apply_data_preparations_seq, calculate_ate, get_transformations, get_base_line, \
    calculate_ate_linear_regression_lstsq, bin_sequences, find_interesting
...
class BruteForceATESearch(ATESearch):
    ...
    #     bit_map = {}
    #     counter = 0
    #     for f in get_transformations().keys():
    #         group = f.split('_')[0]
