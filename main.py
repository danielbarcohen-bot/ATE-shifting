...
if __name__ == "__main__":
    ...
    parser.add_argument("mode", type=str,
                        choices=["brute", "brute_prob", "oe", "parallel", "astar", "probe", "oe_no_bit_mask", "llm_zero_shot",
    ...
    if args.mode in ["probe_probs_no_restart", "probe_probs_with_restart", "greedy", "brute_prob"]:
